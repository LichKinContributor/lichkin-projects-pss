...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/" + PssStatics.PSS_SELL_STOCK_ORDER + "/" + ActivitiStatics.START_PROCESS)
...
public class C extends LKApiBusStartProcessController<I, SysPssSellStockOrderEntity> {
	...
	@Override
	protected LKApiBusStartProcessService<I, SysPssSellStockOrderEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
