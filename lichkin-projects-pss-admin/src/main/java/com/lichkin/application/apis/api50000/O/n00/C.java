...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysPssStorage/O")
...
public class C extends LKApiBusGetOneController<I, O, SysPssStorageEntity> {
	...
	@Override
	protected LKApiBusGetOneService<I, O, SysPssStorageEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
