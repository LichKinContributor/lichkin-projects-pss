...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysPssSupplier/I")
...
public class C extends LKApiBusInsertController<I, SysPssSupplierEntity> {
	...
	@Override
	protected LKApiBusInsertService<I, SysPssSupplierEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
