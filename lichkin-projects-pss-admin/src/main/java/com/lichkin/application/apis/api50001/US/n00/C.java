...
public class C extends LKApiBusUpdateUsingStatusController<LKRequestIDsBean, SysPssSupplierEntity> {
	...
	@Override
	protected LKApiBusUpdateUsingStatusService<LKRequestIDsBean, SysPssSupplierEntity> getService(LKRequestIDsBean cin, ApiKeyValues<LKRequestIDsBean> params) {
		return service;
	}
