...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysPssProduct/I")
...
public class C extends LKApiBusInsertController<I, SysPssProductEntity> {
	...
	@Override
	protected LKApiBusInsertService<I, SysPssProductEntity> getService(I cin) {
		return service;
	}
