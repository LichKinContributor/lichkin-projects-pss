...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysPssProduct/O")
...
public class C extends LKApiBusGetOneController<I, O, SysPssProductEntity> {
	...
	@Override
	protected LKApiBusGetOneService<I, O, SysPssProductEntity> getService(I cin) {
		return service;
	}
