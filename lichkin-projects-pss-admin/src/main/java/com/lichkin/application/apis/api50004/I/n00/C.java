...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysPssStore/I")
...
public class C extends LKApiBusInsertController<I, SysPssStoreEntity> {
	...
	@Override
	protected LKApiBusInsertService<I, SysPssStoreEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
