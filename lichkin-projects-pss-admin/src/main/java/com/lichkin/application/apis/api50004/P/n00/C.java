...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysPssStore/P")
...
public class C extends LKApiBusGetPageController<I, O, SysPssStoreEntity> {
	...
	@Override
	protected LKApiBusGetPageService<I, O, SysPssStoreEntity> getService(I cin) {
		return service;
	}
