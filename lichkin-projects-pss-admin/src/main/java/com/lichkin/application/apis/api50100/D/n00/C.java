...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysPssPurchaseOrder/D")
@LKApiType(apiType = ApiType.COMPANY_BUSINESS)
public class C extends LKApiBusDeleteController<I, SysPssPurchaseOrderEntity> {
	...
	@Override
	protected LKApiBusDeleteService<I, SysPssPurchaseOrderEntity> getService(I cin) {
		return service;
	}
