...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysPssPurchaseOrder/P")
...
public class C extends LKApiBusGetPageController<I, O, SysPssPurchaseOrderEntity> {
	...
	@Override
	protected LKApiBusGetPageService<I, O, SysPssPurchaseOrderEntity> getService(I cin) {
		return service;
	}
