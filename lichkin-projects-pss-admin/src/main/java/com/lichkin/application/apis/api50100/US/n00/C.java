...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysPssPurchaseOrder/US")
...
public class C extends LKApiBusUpdateUsingStatusController<I, SysPssPurchaseOrderEntity> {
	...
	@Override
	protected LKApiBusUpdateUsingStatusService<I, SysPssPurchaseOrderEntity> getService(I cin) {
		return service;
	}
