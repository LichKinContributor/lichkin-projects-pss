...
@RestController("SysPssSellOrderU01Controller")
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysPssSellOrder/U01")
...
public class C extends LKApiBusUpdateController<I, SysPssSellOrderEntity> {
	...
	@Override
	protected LKApiBusUpdateWithoutCheckerService<I, SysPssSellOrderEntity> getService(I cin) {
		return service;
	}
