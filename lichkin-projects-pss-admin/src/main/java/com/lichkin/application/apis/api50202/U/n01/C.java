...
@RestController("SysPssSellStockOrderU01Controller")
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysPssSellStockOrder/U01")
...
public class C extends LKApiBusUpdateController<I, SysPssSellStockOrderEntity> {
	...
	@Override
	protected LKApiBusUpdateWithoutCheckerService<I, SysPssSellStockOrderEntity> getService(I cin) {
		return service;
	}
