...
//		addConditionUsingStatus(params.getCompId(), sql, SysPssSellStockOrderProductR.usingStatus, params.getUsingStatus(), LKUsingStatusEnum.STAND_BY, LKUsingStatusEnum.USING);
