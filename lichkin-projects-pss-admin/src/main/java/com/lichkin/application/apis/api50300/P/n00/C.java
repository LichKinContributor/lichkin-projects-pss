...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysPssOtherStockOrder/P")
...
public class C extends LKApiBusGetPageController<I, O, SysPssOtherStockOrderEntity> {
	...
	@Override
	protected LKApiBusGetPageService<I, O, SysPssOtherStockOrderEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
