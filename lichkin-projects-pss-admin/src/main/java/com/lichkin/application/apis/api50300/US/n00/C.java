...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysPssOtherStockOrder/US")
...
public class C extends LKApiBusUpdateUsingStatusController<I, SysPssOtherStockOrderEntity> {
	...
	@Override
	protected LKApiBusUpdateUsingStatusService<I, SysPssOtherStockOrderEntity> getService(I cin) {
		return service;
	}
