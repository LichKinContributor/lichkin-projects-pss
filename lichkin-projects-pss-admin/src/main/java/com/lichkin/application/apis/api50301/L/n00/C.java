...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysPssOtherStockOrderProduct/L")
...
public class C extends LKApiBusGetListController<I, O, SysPssOtherStockOrderProductEntity> {
	...
	@Override
	protected LKApiBusGetListService<I, O, SysPssOtherStockOrderProductEntity> getService(I cin) {
		return service;
	}
