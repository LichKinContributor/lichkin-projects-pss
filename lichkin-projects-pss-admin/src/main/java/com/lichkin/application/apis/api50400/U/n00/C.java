...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysPssAllotOrder/U")
...
public class C extends LKApiBusUpdateController<I, SysPssAllotOrderEntity> {
	...
	@Override
	protected LKApiBusUpdateWithoutCheckerService<I, SysPssAllotOrderEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
