...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysPssAllotOrderProduct/L")
...
public class C extends LKApiBusGetListController<I, O, SysPssAllotOrderProductEntity> {
	...
	@Override
	protected LKApiBusGetListService<I, O, SysPssAllotOrderProductEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
