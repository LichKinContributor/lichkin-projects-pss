...
//		addConditionUsingStatus(params.getCompId(), sql, SysPssAllotOrderProductR.usingStatus, params.getUsingStatus(), LKUsingStatusEnum.STAND_BY, LKUsingStatusEnum.USING);
