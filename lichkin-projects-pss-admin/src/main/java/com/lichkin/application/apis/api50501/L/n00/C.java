...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysPssStockCheckOrderProduct/L")
...
public class C extends LKApiBusGetListController<I, O, SysPssStockCheckOrderProductEntity> {
	...
	@Override
	protected LKApiBusGetListService<I, O, SysPssStockCheckOrderProductEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
