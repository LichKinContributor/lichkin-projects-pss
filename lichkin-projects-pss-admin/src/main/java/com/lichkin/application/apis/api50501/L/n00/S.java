...
//		addConditionUsingStatus(params.getCompId(), sql, SysPssStockCheckOrderProductR.usingStatus, params.getUsingStatus(), LKUsingStatusEnum.STAND_BY, LKUsingStatusEnum.USING);
