...
@Service(PssStatics.PSS_OTHER_STOCK_OUT_ORDER)
public class ActivitiCallbackService_PSS_OTHER_STOCK_OUT_ORDER extends LKDBService implements ActivitiCallbackService, WithoutActivitiCallbackService<SysPssOtherStockOrderEntity> {
	...
	public void finish(SysActivitiFormDataEntity formDataEntity) {
		SysPssOtherStockOrderEntity processEntity = dao.findOneById(SysPssOtherStockOrderEntity.class, formDataEntity.getField1());
