...
@Service(PssStatics.PSS_PURCHASE_RETURN_ORDER)
public class ActivitiCallbackService_PSS_PURCHASE_RETURN_ORDER extends LKDBService implements ActivitiCallbackService, WithoutActivitiCallbackService<SysPssPurchaseOrderEntity> {
